...
urlpatterns = [
    ...
    # anything going to '/' should be redirected to the urs of imageupload_frontend
    url(r'^', include('atlas.imageupload_frontend.urls', namespace='frontend')),
    ...
    url(r'^api/', include('atlas.imageupload_rest.urls', namespace='api')),
